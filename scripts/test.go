...
func getCurrencyFromCountry(country string) string {
...
func main() {
	fmt.Println(getCurrencyFromCountry("Vietnam"))       // Output: VND
	fmt.Println(getCurrencyFromCountry("VN"))            // Output: VND
	fmt.Println(getCurrencyFromCountry("United States")) // Output: USD
	fmt.Println(getCurrencyFromCountry("US"))            // Output: USD
}
